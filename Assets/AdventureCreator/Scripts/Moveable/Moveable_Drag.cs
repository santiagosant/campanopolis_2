...
namespace AC
{
	...
	public class Moveable_Drag : DragBase
	{
		...
		private float screenToWorldOffset;

		private float lastFrameTotalCursorPositionAlong;
		private bool endLocked = false;

		private AutoMoveTrackData activeAutoMove;
		...
		private void RunInteraction (bool onMove)
		{
		...
		private class AutoMoveTrackData
		{
