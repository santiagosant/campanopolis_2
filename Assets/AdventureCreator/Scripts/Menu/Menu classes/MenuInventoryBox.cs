...
namespace AC
{
	...
	public class MenuInventoryBox : MenuElement
	{
		...
		public override void ShowGUI (Menu menu)
		{
			...
			hoverSoundOverEmptySlots = CustomGUILayout.ToggleLeft ("Play hover sound over empty slots?", hoverSoundOverEmptySlots, apiPrefix + ".hoverSoundOverEmptySlots", "If True, then the hover sound will play even when over an empty slot");
